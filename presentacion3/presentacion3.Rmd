...
![](img/grupo1.png)
Grupos : 5 grupos (4, 4, 3, 3 , 2) : 3 Uniandes, 1, Uruguay, 1 Javeriana Cali
...
|Este proyecto es importante porque | Permite (propica, favorece) la interacción entre estudiantes y profesores en diferentes disciplinas . Genera un espacio 8iempo, fisico, mental) de encuentro permanente entre estudiantes y profesores.|
...
* Articular este esfuerzo con la reforma que estamos haciendo en la cual se han identificado 13 (creo) estrategias didácticas.
